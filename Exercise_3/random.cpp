...
double Random :: Lorentz(double mean, double tau) {
  // This function generates a random number from a Lorentzian distribution with given tau and mean
  double s=Rannyu();
  double x=tau*tan(M_PI*(s-0.5));
  return x + mean;
}
